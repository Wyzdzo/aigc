...
let VerifyEmailUsecase = (() => {
    ...
    var VerifyEmailUsecase = class {
        ...
        static {
            ...
            VerifyEmailUsecase = _classThis = _classDescriptor.value;
        ...
        execute(_params) {
            // TODO: 实现邮箱验证逻辑
            throw new DomainError(VERIFICATION_RECORD_ERROR.OPERATION_NOT_SUPPORTED, '邮箱验证功能暂未实现');
        }
    };
    return VerifyEmailUsecase = _classThis;
})();
