// src/adapters/api/graphql/registration/dto/register-result.dto.ts
 ...
 */
let RegisterResult = (() => {
    let _classDecorators = [ObjectType({ description: '用户注册结果' })];
    ...
    var RegisterResult = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _success_decorators = [Field(() => Boolean, { description: '注册是否成功' })];
            _message_decorators = [Field(() => String, { description: '注册结果消息' })];
            _accountId_decorators = [Field(() => Int, { description: '创建的账户 ID', nullable: true })];
            ...
            RegisterResult = _classThis = _classDescriptor.value;
    ...
    return RegisterResult = _classThis;
})();
