...
// src/adapters/api/graphql/account/dto/get-user-info.input.ts
import { Field, InputType, Int } from '@nestjs/graphql';
import { IsInt, IsOptional } from 'class-validator';
/**
 * 获取用户基本信息输入参数
 */
let GetUserInfoInput = (() => {
    ...
    var GetUserInfoInput = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _accountId_decorators = [Field(() => Int, { nullable: true, description: '账户 ID（不传则默认当前登录用户）' }), IsOptional(), IsInt()];
            ...
            GetUserInfoInput = _classThis = _classDescriptor.value;
    ...
    return GetUserInfoInput = _classThis;
})();
export { GetUserInfoInput };
