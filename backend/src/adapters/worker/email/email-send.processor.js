...
import { EMAIL_QUEUE_NAME } from './email-send.mapper';
let EmailSendProcessor = (() => {
    let _classDecorators = [Injectable(), Processor(EMAIL_QUEUE_NAME)];
    ...
    var EmailSendProcessor = class extends _classSuper {
        ...
        static {
            ...
            EmailSendProcessor = _classThis = _classDescriptor.value;
    ...
    return EmailSendProcessor = _classThis;
})();
export { EmailSendProcessor };
