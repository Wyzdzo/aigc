    ...
    verify(cursor) {
        try {
            ...
            if (error instanceof DomainError)
                throw error;
            throw new DomainError(PAGINATION_ERROR.INVALID_CURSOR, '游标解析失败', { error: error instanceof Error ? error.message : '未知错误' }, error);
        }
    }
}
