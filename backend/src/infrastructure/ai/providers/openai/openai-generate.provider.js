...
let OpenAiGenerateProvider = (() => {
    let _classDecorators = [Injectable()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var OpenAiGenerateProvider = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            OpenAiGenerateProvider = _classThis = _classDescriptor.value;
        ...
        resolveBaseUrl() {
            const baseUrl = this.configService.get('aiWorker.openai.baseUrl', '');
        ...
        resolveApiKey() {
            const apiKey = this.configService.get('aiWorker.openai.apiKey', '');
        ...
        resolveTimeoutMs() {
            const timeoutMs = this.configService.get('aiWorker.openai.generateTimeoutMs', 30000);
    ...
    return OpenAiGenerateProvider = _classThis;
})();
export { OpenAiGenerateProvider };
