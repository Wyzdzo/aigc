...
const getRequiredConfigString = (configService, key) => {
...
const getRequiredConfigNumber = (configService, key) => {
    const value = configService.get(key);
...
const buildRedisOptions = (configService) => {
    ...
    const tlsEnabled = configService.get('redis.tls', false);
    const options = {
        host,
        port,
        db,
...
let RedisLifecycleService = (() => {
    let _classDecorators = [Injectable()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var RedisLifecycleService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            RedisLifecycleService = _classThis = _classDescriptor.value;
    ...
    return RedisLifecycleService = _classThis;
})();
let RedisModule = (() => {
